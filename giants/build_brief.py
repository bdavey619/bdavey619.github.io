...
Pulls Giants data from the MLB Stats API and writes brief.json
...
from engine.team_config import GIANTS  # noqa: E402
...
def _detect_page_themes(subhead, insight):
    ...
    # Giants momentum / streak angle (subhead win-streak lead, insight hot_streak)
    if any(kw in text for kw in [
